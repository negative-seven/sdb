...
SOURCES := $(addprefix $(SOURCES_DIR)/,bounding_box.cpp bounding_square.cpp critical_section.cpp error.cpp flash_movie_clip.cpp flash_timeline.cpp main.cpp matrix4x4.cpp system.cpp vector2.cpp)
